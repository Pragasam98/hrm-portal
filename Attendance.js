...
import OrgConfigIcon from "../assets/icons/attendances.svg"; // Org config icon
        ...
        <ContentWrapper>
          ...
          <CardContainer>
            ...
            <Card onClick={handleAddEmployee}>
              <CardIcon src={AddEmployeeIcon} alt="Leave Request" />
              <CardTitle>Leave Request</CardTitle>
            </Card>
            {/* Card for Organization Config */}
            <Card onClick={handleOrgConfig}>
              <CardIcon src={OrgConfigIcon} alt="Attendances" />
